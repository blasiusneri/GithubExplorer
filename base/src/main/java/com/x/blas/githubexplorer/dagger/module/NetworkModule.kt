 ...
 */
@Module
//MODULARIZED - 2.02 Move NetworkModule to base but keep the GithubService Provider in app module, so create NetworkServiceModule.kt for GithubService Provider
class NetworkModule {
